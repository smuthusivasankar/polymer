...
protected String GetJSONFromQueryString()
{
    ...
    string fragmentType = "Product-Enrichment";
...
<link rel="import" href="http://10.67.90.232:88/src/store-description-stack/store-description-stack.html">
<store-description-stack filter='<%= GetJSONFromQueryString()%>' ></store-description-stack>